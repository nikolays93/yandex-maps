...
class Plugin {
     ...
     * Use the "regenerate_thumbs_cap" filter instead.
     *
     * @var string
     */
    private $_permissions = 'manage_options';
    ...
    public function __init() {
        ...
        $this->_permissions = apply_filters( self::PREFIX . 'permissions',
            $this->_permissions );

        $this->mapsCollection = new MapsCollection();
